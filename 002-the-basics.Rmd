...
Many people wonder if EarthTime is compatible with mobile devices. In short, the answer is “yes”; however, as we’ll cover in the next section, only EarthTime stories are currently available on mobile devices. Users wishing to have a more interactive experience and explore various data layers should access EarthTime via a browser on a standard desktop or laptop computer. 
