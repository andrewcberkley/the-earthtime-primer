...
* __Draw in your audience:__ provide a hook that will capture the attention of an online audience 
* __The words:__ use is language that is accessible to a lay audience
* __Set the Scene:__ start by describing the situation in the world today and where your issue fits within global developments
* __Provide examples:__ choose 2-3 examples that illustrate the larger issue at hand
* __End on a high note:__ illustrate a few policy examples or business initiatives that can be scaled up to provide a call to action
